...
<body class="overflow-x-hidden">
    ...
    <div class="container">
      <div class="row">
        <div class="about text-center">
          <h1 id="about-us">من نحن<br><span id="about-subtitle">استمتع براحة القطن الخالصة</span></h1>
          <p id="about-description">
            في <strong>مخورة</strong>، نحتفل بجمال القطن الطبيعي — نقي، ناعم، وخالد. كل قطعة مصنوعة بعناية لتمزج بين
            الراحة والجودة ولمسة من الأناقة اليومية.
          </p>
        </div>
      </div>
    </div>
  ...
  <!-- How It Works -->
  <section class="how-us-work container">
    <h2 id="how-quality-title">كيف تجلب لك مخورة الجودة</h2>
    <div class="row">
      <div class="col-lg-4">
        <div class="work-box">
          <div class="work-num">1</div>
          <h4 id="pure-materials">مواد نقية</h4>
          <p id="pure-materials-desc">
            نستخدم فقط قطن طبيعي 100% لإنشاء أقمشة تتنفس، مريحة، وتدوم لسنوات
          </p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="work-box">
          ...
          <h4 id="modern-craftsmanship">الحرفية الحديثة</h4>
          <p id="modern-craftsmanship-desc">
            يجمع فريقنا بين النسيج التقليدي والتقنيات الحديثة لتقديم الملمس والنعومة المثالية.
          </p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="work-box">
          ...
          <h4 id="trusted-quality">جودة موثوقة</h4>
          <p id="trusted-quality-desc">
            تمر كل قطعة بفحص جودة صارم — مما يضمن أن ما يصل إليك ليس أقل من الراحة المثالية.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="container mission">
    <h2 class="text-center">ما يقوله عملاؤنا</h2>
    <p class="text-center">
      استمعوا إلى تجارب أولئك الذين جربوا النعومة الحقيقية والراحة الدائمة لقطن موخوارا.
    </p>
    <div class="row row-gap-5">
      <div class="col-lg-4">
        <div class="mission-box">
          <div class="quot-mark">“</div>
          <p>
            جودة القطن لا تُضاهى! ناعم، قابل للتنفس، ويمنح شعورًا رائعًا على البشرة.
            لا أستطيع تخيّل شراء الأقمشة من أي مكان آخر."
          </p>
          <h6>ليلى أحمد</h6>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="mission-box">
          <div class="quot-mark">“</div>
          <p>أحببت التصاميم والألوان — أنيقة وبسيطة في نفس الوقت.
            مثالية لكلٍ من الملابس ومشاريع ديكور المنازل."
          </p>
          <h6>عمر حسين</h6>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="mission-box">
          <div class="quot-mark">“</div>
          <p>
            من النادر العثور على قطن بهذه الدرجة من النقاء والنعومة.
            كل عملية شراء من مخورة تذكرني بجودة التصنيع المميزة."
  ...
  <!-- Salla SDK and Product API for categories -->
  ...
  <script>
    // Initialize cart integration and user info
