  ...
  <section class="profile">
    <div class="profile-container">
      ...
      <div class="profile-header">
        <img id="profile-avatar" src="https://i.pravatar.cc/150?img=3" alt="User Avatar">
        <h2 id="profile-name">مصطفى سامي</h2>
        <span id="profile-role" class="role">عميل</span>
      </div>
      ...
      <div class="profile-card">
        ...
        <div class="info-row">
          ...
          <span id="profile-email" class="value">mostafa@email.com</span>
        </div>

        <div class="info-row">
          <span class="label">رقم الهاتف</span>
          <span id="profile-phone" class="value">+20 109 123 4567</span>
        </div>
      </div>
