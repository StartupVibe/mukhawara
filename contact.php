...
<body>
  ...
  <section class="contact-section text-center">
    <div class="container">
      <h2 class="fw-bold mb-4" id="contact-title">تواصل معنا</h2>
      <p class="p-sec mb-5" id="contact-subtitle">يسعدنا التواصل معكم! لا تترددوا في الاتصال بنا لأي استفسارات أو
        ملاحظات.</p>

      <div class="row text-start">
        <!-- Contact Info -->
        <div class="col-lg-5 mb-4 mb-lg-0">
          <h5 class="mb-4 fw-bold text-end px-2" id="contact-information">معلومات التواصل</h5>
          <div class="contact-info mb-3 d-flex align-items-center gap-2">
        ...
        <div class="col-lg-7">
          <form class="contact-form">
            <div class="row">
              <div class="col-md-6">
                <input type="text" id="full-name-input" placeholder="الاسم" data-translate="full-name" required>
              </div>
              <div class="col-md-6">
                <input type="email" id="email-address-input" placeholder="البريد الالكتروني"
                  data-translate="email-address" required>
              </div>
            </div>
            <input type="text" id="subject-input" placeholder="الموضوع" data-translate="subject" required>
            <textarea rows="5" id="your-message-input" placeholder="ارسل لنا طلبك ..." data-translate="your-message"
              required></textarea>
            <button type="submit" id="send-message">ارسال</button>
          </form>
        </div>
      </div>
    </div>
